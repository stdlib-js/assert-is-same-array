...
```javascript
import isSameArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-same-array@v0.2.3-esm/index.mjs';
```
...
[@stdlib/assert/is-equal-array]: https://github.com/stdlib-js/assert-is-equal-array/tree/esm

[@stdlib/assert/is-same-array-like]: https://github.com/stdlib-js/assert-is-same-array-like/tree/esm
